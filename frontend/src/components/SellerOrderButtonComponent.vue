<script>
export default{
  name: 'SellerOrderButtonComponent',
  methods: {
    navigateSellerOrder() {
...
<template>
  <button @click="navigateSellerOrder" type="button" class="text-white bg-secondary hover:bg-green-800 focus:ring-4 focus:outline-none peer-focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-green-800 dark:hover:bg-green-700 dark:focus:ring-offset-green-300">
