<script>
export default{
  name: 'DeliveryButtonComponent',
  methods: {
    navigateDelivery() {
      this.$router.push({name: 'delivery-available-orders'});
    }
  }
}
</script>
